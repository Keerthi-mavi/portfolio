            ...
            <div class="container mx-auto px-4 mt-28 md:mt-0">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="md:w-2/3 md:pl-12">
                        ...
                        <a class="bg-[#001c5579]  px-6 py-3 rounded-full font-semibold hover:bg-[#001c554d] transition-colors duration-300 mt-7" download="Mavillapally Keerthi resume" href="/Mavillapally_keerthi_resume.pdf" target='_blank'>Download Resume</a>
                    </div>
                </div>
            </div>
