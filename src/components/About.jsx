                ...
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="md:w-2/3 md:pl-12">
                        ...
                        <p class="text-lg mb-6 ">
                            Software Engineer with more than 3 years of experience as a Fullstack developer. Experienced in Web Development, adept in contributing through all stages of web development. Good communication skills and a team player with a strong willingness to learn new technologies.
                        </p>
                        <p class="text-lg mb-6 ">
                            Interested in exploring new technologies, integrating and playing around with open source softwares.
                        </p>
                        <a class="bg-[#001c5579]  px-6 py-3 rounded-full font-semibold hover:bg-[#001c554d] transition-colors duration-300 mt-7" download="Mavillapally_Keerthi_resume" href="/Mavillapally_keerthi_resume.pdf" target='_blank'>Download Resume</a>
                    </div>
                </div>
            </div>
