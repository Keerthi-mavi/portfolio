                ...
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="md:w-2/3 md:pl-12">
                        ...
                        <p class="text-lg mb-6 ">
                            Software Engineer with 4 years of experience as a Fullstack developer. Experienced in Web Development, adept in contributing through all stages of web development. Good communication skills and a team player with a strong willingness to learn new technologies.
                        </p>
                        <p class="text-lg mb-6 ">
